...
procedure TFrm_MenuData.BtnRekeningClick(Sender: TObject);
var
  f: TFrm_DaftarAkun;
  ts: TcxTabSheet;
begin
...
procedure TFrm_MenuData.BtnSatuanClick(Sender: TObject);
var
  f: TFrm_DaftarSatuan;
  ts: TcxTabSheet;
begin
...
procedure TFrm_MenuData.BtnKontakClick(Sender: TObject);
var
  f: TFrm_DaftarKontak;
  ts: TcxTabSheet;
begin
...
procedure TFrm_MenuData.BtnBarangClick(Sender: TObject);
var
  f: TFrm_DaftarBarang;
  ts: TcxTabSheet;
begin
...
procedure TFrm_MenuData.RzLabel1MouseEnter(Sender: TObject);
begin
  RzLabel1.Font.Style := [fsBold,fsUnderline];
  RzLabel1.Cursor := crHandPoint;
end;

procedure TFrm_MenuData.RzLabel1MouseLeave(Sender: TObject);
begin
  RzLabel1.Font.Style := [];
  RzLabel1.Cursor := crDrag;
end;

procedure TFrm_MenuData.RzLabel1Click(Sender: TObject);
var
...
procedure TFrm_MenuData.RzLabel2MouseEnter(Sender: TObject);
begin
  RzLabel2.Font.Style := [fsBold,fsUnderline];
  RzLabel2.Cursor := crHandPoint;
end;

procedure TFrm_MenuData.RzLabel2MouseLeave(Sender: TObject);
begin
  RzLabel2.Font.Style := [];
  RzLabel2.Cursor := crDrag;
end;

procedure TFrm_MenuData.RzLabel2Click(Sender: TObject);
var
  f: TFrm_DaftarGudang;
  ts: TcxTabSheet;
begin
...
procedure TFrm_MenuData.BtnMenuClick(Sender: TObject);
begin
...
procedure TFrm_MenuData.RzToolButton1Click(Sender: TObject);
var
  f: TFrm_DaftarPajak;
  ts: TcxTabSheet;
begin
...
procedure TFrm_MenuData.RzToolButton2Click(Sender: TObject);
var
  f: TFrm_DaftarPPh;
  ts: TcxTabSheet;
begin
...
procedure TFrm_MenuData.RzToolButton3Click(Sender: TObject);
var
...
procedure TFrm_MenuData.RzLabel3MouseEnter(Sender: TObject);
begin
  RzLabel3.Font.Style := [fsBold,fsUnderline];
  RzLabel3.Cursor := crHandPoint;
end;

procedure TFrm_MenuData.RzLabel3MouseLeave(Sender: TObject);
begin
  RzLabel3.Font.Style := [];
  RzLabel3.Cursor := crDrag;
end;

procedure TFrm_MenuData.RzLabel3Click(Sender: TObject);
var
  f: TFrm_DaftarFooter;
  ts: TcxTabSheet;
begin
