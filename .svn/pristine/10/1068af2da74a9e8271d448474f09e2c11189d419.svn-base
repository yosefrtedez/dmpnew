  ...
  with Frm_InputGudang do begin
    ...
    if ShowModal = mrok then begin
      with TZQuery.Create(Self)do begin
        Connection := DM.con;
        Close;
        SQL.Text := 'insert into tbl_gudang values (:a,:b,:c,:d,:e,:f,:g,:h,:i,:j,:k)';
        ...
        ParamByname('k').Value := cxlCabang.EditValue;
        ExecSQL;
        Free;
      end;
      RefreshQ;
...
begin
  ...
  with TZQuery.Create(Self)do begin
    ...
    with Frm_InputGudang do begin
      ...
      cxlCabang.EditValue := FieldValues['nocabang'];
      ...
      if Frm_InputGudang.ShowModal = mrok then begin
        Close;
        SQL.Clear;
        SQL.Text := 'update tbl_gudang set kodegudang=:a,namagudang=:b,alamat1gudang=:c,alamat2gudang=:d,kotagudang=:e,kodeposgudang=:f,negaragudang=:g, keterangan=:h, aktif=:i,nocabang=:k where nogudang=:na';
