object Frm_RincianGiroMasuk: TFrm_RincianGiroMasuk
  Left = 616
  Top = 436
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Data Transaksi Giro'
  ClientHeight = 212
  ClientWidth = 461
  Color = clBtnFace
