object Frm_DataPembelianRequestOrder: TFrm_DataPembelianRequestOrder
  Left = 428
  Top = 42
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Data Pembelian Order'
  ClientHeight = 749
  ClientWidth = 638
  Color = clBtnFace
  ...
  object QData: TZQuery
    ...
    SQL.Strings = (
      'select a.*,ifnull(b.namakontak,'#39#39')as namakontak from'
        ...
        '(SELECT * FROM tbl_pembelianorder WHERE nopembelianrequest=:np)a' +
        's a'
